...
class ExpensesListView(CashRegisterRequiredMixin, PermissionMixin, FormView):
...
class ExpensesCreateView(CashRegisterRequiredMixin, PermissionMixin, CreateView):
    model = Expenses
...
class ExpensesUpdateView(CashRegisterRequiredMixin, PermissionMixin, UpdateView):
    model = Expenses
    template_name = 'frm/expenses/create.html'
    form_class = ExpensesForm
    success_url = reverse_lazy('expenses_list')
...
class ExpensesDeleteView(SupervisorDeleteApprovalMixin, CashRegisterRequiredMixin, PermissionMixin, DeleteView):
    model = Expenses
